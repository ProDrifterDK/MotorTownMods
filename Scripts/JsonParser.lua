...
nil itself, or if you explicitly use json.null as a table value.
...
---@param str string Input string
---@param pos number Starting string position
---@param val? string
---@return string value string value inside the closed quote
---@return number pos pos is after the closing quote character.
